...
class PDG1Test(leftchangedlines: Array[Int], rightchangedlines: Array[Int]) extends JPDGTest  with PropagateTaint{
  override def getClassName(): String = "samples.PDG1"
