...
public class UnitGraphNodes extends UnitGraph implements ExceptionalGraph<Unit> {
    ...
    public UnitGraphNodes(Body body, boolean omitExceptingUnitEdges){
        this(body, Scene.v().getDefaultThrowAnalysis(), omitExceptingUnitEdges);
    }
...
//    }
    ...
    protected void initialize(ThrowAnalysis throwAnalysis, boolean omitExceptingUnitEdges) {
        ...
        Local dummyLocal = new LocalDummy("Start", NullType.v());
        UnitDummy startStmt = new UnitDummy(dummyLocal, "Start");

        dummyLocal = new LocalDummy("Stop", NullType.v());
        UnitDummy stopStmt = new UnitDummy(dummyLocal, "Stop");

        dummyLocal = new LocalDummy("EntryPoint", NullType.v());
